...
@property (nonatomic, strong) NSDate *tweetDate; // Display date
@property (nonatomic, strong) NSString *createdAtString; // Display date in MM/DD/YY format
@property (nonatomic, strong) NSURL *link; // Embedded link
